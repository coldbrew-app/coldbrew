...
const en = {
  ...
  newQueuePrioritiesHelp:
    "Priorities are copied from your default queue. You can then configure them independently.",
...
const ru = defineTranslations({
  ...
  newQueuePrioritiesHelp:
    "Приоритеты будут скопированы из очереди по умолчанию. Затем их можно настроить независимо.",
