...
const en = {
  ...
  deadLettersDescription: "NATS chat events quarantined after decoding failed.",
...
const ru = defineTranslations({
  ...
  deadLettersDescription: "События чата NATS, изолированные после ошибки декодирования.",
  ...
  queueConfiguration: "Очереди и доступ по ссылке",
  queues: "Очереди",
